...
namespace System.Text.RegularExpressions
{
    ...
    internal sealed class RegexCompiler : RegexDynamicModule
    {
        ...
        private RegexCompiler(int moduleNum)
            : base(moduleNum, null, null, null)
        {
        }

        private RegexCompiler(int moduleNum, AssemblyName an, CustomAttributeBuilder[] attribs, String resourceFile)
            : base(moduleNum, an, attribs, resourceFile)
        {
        }
